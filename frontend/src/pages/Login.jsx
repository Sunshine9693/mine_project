        ...
        <GlassCard className="p-8 border border-white/80 shadow-glass-card">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-light tracking-tight text-aura-text-primary text-center">
              Welcome to <span className="font-semibold text-gradient-purple uppercase tracking-wider">Sunshine</span>
            </h1>
          ...
          <div className="mt-8 text-center text-xs">
            <span className="text-aura-text-muted">Don't have an account? </span>
            <Link 
              to="/register" 
