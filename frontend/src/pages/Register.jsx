        ...
        <GlassCard className="p-8 border border-white/80 shadow-glass-card">
          ...
          <div className="flex flex-col items-center mb-6">
            ...
            <h1 className="text-2xl font-light tracking-tight text-aura-text-primary text-center">
              Create <span className="font-semibold text-gradient-purple uppercase tracking-wider">Sunshine</span> Account
            </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-4.5 flex items-center text-aura-text-muted">
                ...
                <input
                  ...
                  className="w-full pl-11.5 pr-4 py-3.5 rounded-2xl outline-none glass-input text-sm text-aura-text-primary placeholder-aura-text-muted focus:border-aura-soft-purple focus:ring-1 focus:ring-aura-soft-purple/30 transition-all"
                  required
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-11 pr-12 py-3.5 rounded-2xl outline-none glass-input text-sm text-aura-text-primary placeholder-aura-text-muted focus:border-aura-soft-purple focus:ring-1 focus:ring-aura-soft-purple/30 transition-all"
                  required
                />
                <button
                  type="button"
          ...
          <div className="mt-6 text-center text-xs">
            <span className="text-aura-text-muted">Already have an account? </span>
            <Link 
              to="/login" 
